    ...
    var render = function render(res) {
      ...
      for (var j = 0, len1 = res.list.length; j < len1; j++) {
        ...
        for (var i = 0, len2 = data.link.length; i < len2; i++) {
          ...
          var src = 'img/' + data.link[i] + '.' + data.type[i] + '?imageMogr2/auto-orient';
          var target = src;
          var type ;
        ...
        if(data.month=="" || data.month=="0"){
          ulTmpl = ulTmpl + '<section class="archives album"><h1 class="year">' + data.year + '<em class="title">' + title + '</em>' + '</h1>\
          <ul class="img-box-ul">' + liTmpl + '</ul>\
          </section>';
        }else{
          ulTmpl = ulTmpl + '<section class="archives album"><h1 class="year">' + data.year + '<em>' + data.month + '月 </em>' + '<em class="title">' + title + '</em>' + '</h1>\
          <ul class="img-box-ul">' + liTmpl + '</ul>\
          </section>';
        }
